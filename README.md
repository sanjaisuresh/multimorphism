...
1. Clone the repository:
   ```bash
   git clone https://github.com/sanjaisuresh/multimorphism.git
   ```
...
We love contributions! Whether it's a bug fix, a new theme, or a component enhancement, your help is welcome.
...
Please make sure to test your changes locally and ensure they look good across all existing themes!
